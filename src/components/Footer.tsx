      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-rollback-dark">
              Rollback
            </h3>
          ...
          <div className="space-y-4">
            <h4 className="text-sm font-semibold text-rollback-dark">
              Product
            </h4>
        ...
        <div className="mt-8 pt-8 border-t border-rollback-light">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link
                to="/privacy"
                className="text-sm text-rollback-brown hover:text-rollback-dark"
              >
                Privacy Policy
              </Link>
              <Link
